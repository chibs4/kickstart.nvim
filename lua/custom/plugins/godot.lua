...
require('godotdev').setup {
  ...
  godot_path = 'C:/Users/Chibs/Desktop/godot/godot.exe', -- executable used by :GodotRun* and health checks
...
vim.keymap.set('n', '<F5>', ':GodotRunProject<CR>')
vim.keymap.set('n', '<F6>', ':GodotRunCurrentScene<CR>')
